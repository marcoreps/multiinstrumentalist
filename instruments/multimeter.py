...
class HPM7177(multimeter):
    ...
    def get_read_val(self):
        ...
        HMP2_fit2=1.02782955913447e-6+3.04254972897816e-6*math.sin(0.00322438501023585*x1)-2.54617098552864e-6*math.cos(2.41476535668804+0.00322438496390789*x1+1.47267948257617*math.sin(0.0211347361227292+0.00322438501023585*x1))
        return HMP2_fit1+HMP2_fit2
