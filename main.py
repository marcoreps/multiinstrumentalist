...
instruments["S7081"]=S7081(ip=vxi_ip, gpib_address=6, loctite, title="Bench S7081")
instruments["2002"]=K2002(ip=vxi_ip, gpib_address=5, loctite, title="2002")
#instruments["2002"].config_2ADC_9digit_filtered()
instruments["2002"].config_20DCV_9digit_filtered()
instruments["R6581T"]=R6581T(ip=vxi_ip, gpib_address=3, loctite, title="Bench R6581T")
...
instruments["F5700A"]=F5700A(ip=vxi_ip, gpib_address=1, loctite, title="Fluke 5700A")
